...
typedef struct MF_Entity
{
    ...
    /** \brief     Whether the "origin" field exists or not
     * 
     *  \details   When the properties are parsed out of the entity,
     *             there is an origin field which can be parsed into
     *             MF_Vector3_t. If that key exists in the properties
                   list, then "hasOrigin" is true. Otherwise, it is
                   false.
     */
    bool hasOrigin;
     ...
     *
     *  \details   The origin of the entity parsed out from the "origin" key in the Entity
     *             attributes
     */
    MF_Vector3 origin;
